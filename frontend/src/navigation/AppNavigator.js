...
const TABS = [
   { name: 'Home',          label: 'Ana Sayfa', icon: ['home','home-outline'],                       component: HomeScreen },
   { name: 'Transactions',  label: 'İşlemler',  icon: ['swap-horizontal','swap-horizontal-outline'], component: TransactionsScreen },
